...
export default function GameFrame({
  ...
  return (
    <div className="min-h-screen bg-[#071a17] text-[#7ad0c0] font-mono relative overflow-hidden flex items-center justify-center p-4">
      {/* Device frame */}
      ...
      {/* Game console frame */}
      <div className="relative max-w-4xl w-full mx-auto bg-[#0a2320] rounded-2xl p-6 md:p-10 shadow-[0_0_50px_rgba(0,20,15,0.7)] border-t border-[#1a3a35] border-l">
        {/* Device texture */}
        <div className="absolute inset-0 bg-noise opacity-10 pointer-events-none mix-blend-overlay rounded-2xl"></div>

        {/* Device brand */}
        <div className="absolute top-2 left-1/2 transform -translate-x-1/2 text-xs text-[#7ad0c0]/30 font-bold tracking-widest">
          PORTFOLIO-BOY ADVANCE
        </div>

        {/* Sound toggle */}
        <button
          onClick={() => setSound(!sound)}
          className="absolute top-2 right-2 md:top-4 md:right-4 text-[#7ad0c0]/50 hover:text-[#7ad0c0] z-10"
        ...
        <div
          className={cn(
            "relative border-8 border-[#0f2f2a] rounded-lg bg-[#031a17] shadow-inner overflow-hidden",
        ...
        >
          ...
          <div className="relative z-0 p-4">
            ...
            {!hideHeader && (
              <header className="border-2 border-[#7ad0c0] p-4 mb-6 relative">
                <div className="absolute top-0 left-0 w-full h-1 bg-[#7ad0c0] opacity-20"></div>
                <div className="flex justify-between items-center">
                  <h1 className="text-xl md:text-3xl font-bold tracking-tight pixelated">{title}</h1>
                  <div className="flex items-center gap-2 text-xs">
                    <span className="inline-block w-3 h-3 bg-[#7ad0c0] animate-pulse"></span>
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Zap className="w-3 h-3 text-[#7ad0c0]" />
                    <div className="w-full h-2 bg-[#0f382f] rounded-sm overflow-hidden">
            ...
            {/* Main game screen */}
            <main className={cn("border-2 border-[#7ad0c0] p-4 mb-6 min-h-[50vh] relative", hideHeader && "mt-0")}>
              <div className="absolute top-0 left-0 w-full h-1 bg-[#7ad0c0] opacity-20"></div>
        ...
        <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="hidden md:block">
            <div className="circuit-pattern w-16 h-16 rounded-full"></div>
          </div>
